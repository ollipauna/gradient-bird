from obstacle import Obstacle, Obstacles, ObstacleGenerator
...
class Generation:
	def __init__(self, n, genomes, config, speed, screen, screenwidth, screenheight, ball_initial_x, ball_initial_y, gravity):
		self.screenheight = screenheight
		self.screen = screen
		self.bots = Bots(genomes, config, screen, gravity, ball_initial_x, ball_initial_y)
